...
async def create_opportunity(
    ...
    params = {
        ...
        "stage": request.stage,
        "expected_close_date": date.fromisoformat(request.expected_close_date) if request.expected_close_date else None,
    }
...
async def update_opportunity(
    ...
    if request.expected_close_date is not None:
        ...
        # Handle empty string as NULL, otherwise convert to date object
        if request.expected_close_date:
            params["expected_close_date"] = date.fromisoformat(request.expected_close_date)
        else:
            params["expected_close_date"] = None
